...
namespace Washouse.Data.Migrations
{
    ...
    [Migration("20230425200614_add isOnlinePayment CenterRequest")]
    partial class addisOnlinePaymentCenterRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Washouse.Model.Models.DeliveryPriceChart", b =>
                {
                    ...
                    b.HasIndex(new[] { "CenterId" }, "IX_DeliveryPriceCharts_CenterId");
            ...
            modelBuilder.Entity("Washouse.Model.Models.Feedback", b =>
                {
                    ...
                    b.HasIndex(new[] { "OrderId" }, "IX_Feedbacks_OrderId");

                    b.HasIndex(new[] { "ServiceId" }, "IX_Feedbacks_ServiceId");
            ...
            modelBuilder.Entity("Washouse.Model.Models.Order", b =>
                {
                    ...
                    b.Property<string>("CancelReasonByCustomer")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("CancelReasonByStaff")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Washouse.Model.Models.OrderDetailTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "OrderDetailId" }, "IX_OrderDetailTrackings_OrderId");

                    b.ToTable("OrderDetailTrackings");
                });

            modelBuilder.Entity("Washouse.Model.Models.OrderTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Washouse.Model.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Washouse.Model.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Washouse.Model.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Washouse.Model.Models.Account", b =>
                {
                    ...
                    b.HasOne("Washouse.Model.Models.Wallet", "Wallet")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Washouse.Model.Models.WalletTransaction", b =>
                {
                    b.HasOne("Washouse.Model.Models.Wallet", "FromWallet")
                        .WithMany("WalletTransactionFromWallets")
                        .HasForeignKey("FromWalletId")
                        .IsRequired()
                        .HasConstraintName("FK_WalletTransactions_Wallets_From");

                    b.HasOne("Washouse.Model.Models.Payment", "Payment")
                        .WithMany("WalletTransactions")
                        .HasForeignKey("PaymentId")
                        .IsRequired()
                        .HasConstraintName("FK_WalletTransactions_Payments");

                    b.HasOne("Washouse.Model.Models.Wallet", "ToWallet")
                        .WithMany("WalletTransactionToWallets")
            ...
            modelBuilder.Entity("Washouse.Model.Models.OrderDetail", b =>
                {
                    b.Navigation("OrderDetailTrackings");
                });
            ...
            modelBuilder.Entity("Washouse.Model.Models.Wallet", b =>
                {
                    ...
                    b.Navigation("WalletTransactionFromWallets");

                    b.Navigation("WalletTransactionToWallets");
                });
